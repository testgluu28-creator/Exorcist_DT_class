...
window.EXORCIST_DATA = {
  ...
  /* ---- tag housekeeping ----
     Both lists are empty: every tree file in use is on the current naming.

     Next time a tag changes, put it here rather than only editing tagGroups —
     every tree file and stored browser copy is then migrated on load, so
     nothing has to be fixed up by hand:

       tagRenames: { 'old_name': 'new_name' },
       tagRetired: ['tag_that_no_longer_exists'],

     A tag left out of both simply becomes an unregistered one, which the page
     keeps and files under the last tag group. */
  tagRenames: {},
  tagRetired: [],
  ...
  defaultTree: {
    ...
    {"id": 1, "x": 340, "y": 178, "type": "default", "region": "combat", "name": "Rite of Wrath", "tags": ["melee_dmg+"], "desc": "+5% Melee Damage."},
    ...
    {"id": 3, "x": 1040, "y": 178, "type": "default", "region": "hybrid", "name": "Braced Litany", "tags": ["tough+"], "desc": "+15 Toughness."},
    {"id": 4, "x": 230, "y": 286, "type": "default", "region": "combat", "name": "Kindled Ire", "tags": ["DoT_dmg+"], "desc": "Soulblaze you apply deals +15% damage."},
    ...
    {"id": 7, "x": 800, "y": 286, "type": "default", "region": "support", "name": "Soul Thrift", "tags": ["SF_economy"], "desc": "-10% Soulfire cost on all Incantations."},
    {"id": 8, "x": 1040, "y": 286, "type": "default", "region": "hybrid", "name": "Staggering Word", "tags": ["stag+"], "desc": "+15% Impact with all weapons."},
    {"id": 9, "x": 1260, "y": 286, "type": "default", "region": "hybrid", "name": "Wary Step", "tags": ["mob+"], "desc": "+5% Movement Speed."},
    ...
    {"id": 12, "x": 1040, "y": 394, "type": "blitz", "region": "hybrid", "name": "Telekine Palm", "tags": ["util"], "desc": "Manipulate objects at range, clear hazard patches, or extract a downed ally to your position. Costs 1-2 SE."},
    ...
    {"id": 16, "x": 800, "y": 502, "type": "blitzmod", "region": "support", "name": "Ember Thrift", "tags": ["SF_economy"], "desc": "Sanctic Dome costs 1 fewer Soul Ember."},
    {"id": 17, "x": 930, "y": 502, "type": "blitzmod", "region": "hybrid", "name": "Far Reach", "tags": ["util"], "desc": "Telekine Palm range +50%. Hazard clearing radius +40%."},
    ...
    {"id": 19, "x": 230, "y": 610, "type": "default", "region": "combat", "name": "Anathema", "tags": ["dmg_vs_daemon+"], "desc": "+20% damage to Daemonhosts and Infested."},
    ...
    {"id": 21, "x": 690, "y": 610, "type": "stat", "region": "support", "name": "Toughness Boost", "tags": ["tough+"], "desc": "+20 Toughness."},
    {"id": 22, "x": 580, "y": 610, "type": "default", "region": "support", "name": "Litany Unbroken", "tags": ["inc-n_power+"], "desc": "Single-target Incantations restore an extra 8% Toughness."},
    {"id": 23, "x": 1040, "y": 610, "type": "default", "region": "hybrid", "name": "Cowing Presence", "tags": ["supress+"], "desc": "Staggering an enemy suppresses others within 4m."},
    {"id": 24, "x": 1260, "y": 610, "type": "default", "region": "hybrid", "name": "White Noise", "tags": ["supress+"], "desc": "Suppression you inflict lasts 1.5s longer, and suppressed shooters move 15% slower."},
    {"id": 25, "x": 340, "y": 718, "type": "aura", "region": "combat", "name": "Psyniscience", "tags": ["util"], "desc": "Specialists and Disablers within 25m are outlined for all allies in coherency, through walls."},
    ...
    {"id": 28, "x": 340, "y": 826, "type": "ability", "region": "combat", "name": "Dome of Banishment", "tags": ["DoT_dmg+"], "desc": "Pulls non-boss enemies into an AoE and applies 10 Soulblaze, +5 per ally also inside."},
    {"id": 29, "x": 690, "y": 826, "type": "ability", "region": "support", "name": "Distort Vision", "tags": ["util"], "desc": "Invisible for 7s and spawn an improved decoy that absorbs aggro. Support Incantations do not break stealth until they resolve."},
    ...
    {"id": 32, "x": 450, "y": 934, "type": "abilmod", "region": "combat", "name": "Hungering Dome", "tags": ["SF_on_kill"], "desc": "Enemies dying inside Dome of Banishment each grant Soulfire."},
    ...
    {"id": 34, "x": 800, "y": 934, "type": "abilmod", "region": "support", "name": "Veiled Ministry", "tags": ["inc-n_power+"], "desc": "Incantations cast from stealth cost 40% less Soulfire."},
    ...
    {"id": 36, "x": 1150, "y": 934, "type": "abilmod", "region": "hybrid", "name": "Unburdened Grip", "tags": ["ability_CD+"], "desc": "Killing the thrown target refunds 20% Ability cooldown."},
    {"id": 37, "x": 340, "y": 1042, "type": "abilmod", "region": "combat", "name": "Banishment Echo", "tags": ["ability_CD+"], "desc": "Dome of Banishment cooldown -20%."},
    ...
    {"id": 40, "x": 120, "y": 1042, "type": "stat", "region": "combat", "name": "Melee Damage Boost", "tags": ["melee_dmg+"], "desc": "+10% Melee Damage."},
    {"id": 41, "x": 1260, "y": 1042, "type": "stat", "region": "hybrid", "name": "Impact Boost", "tags": ["stag+"], "desc": "+10% Impact."},
    ...
    {"id": 47, "x": 1150, "y": 1150, "type": "default", "region": "hybrid", "name": "Toll of Control", "tags": ["gain_tough"], "desc": "Staggering an Elite restores 8% Toughness."},
    {"id": 48, "x": 120, "y": 1258, "type": "default", "region": "combat", "name": "Pyre Unbound", "tags": ["DoT_dmg+"], "desc": "Soulblaze stacks past the normal cap, to 12."},
    {"id": 49, "x": 340, "y": 1258, "type": "default", "region": "combat", "name": "Weakspot Doctrine", "tags": ["wspot_dmg+"], "desc": "+15% Weakspot Damage."},
    ...
    {"id": 54, "x": 120, "y": 610, "type": "default", "region": "combat", "name": "Ember Draught", "tags": ["SF_on_kill"], "desc": "Melee kills generate Soulfire."},
    ...
    {"id": 56, "x": 690, "y": 1150, "type": "default", "region": "support", "name": "Patient Litany", "tags": ["SF_economy"], "desc": "Soulfire regenerates 25% faster while no ally is below 50% Toughness."},
    {"id": 57, "x": 340, "y": 1150, "type": "default", "region": "combat", "name": "Ranged Doctrine", "tags": ["rng_dmg+"], "desc": "+8% Ranged Damage."},
    ...
    {"id": 59, "x": 1040, "y": 1150, "type": "stat", "region": "hybrid", "name": "Toughness Boost", "tags": ["tough+"], "desc": "+20 Toughness."},
    {"id": 60, "x": 230, "y": 1258, "type": "default", "region": "combat", "name": "Kindler", "tags": ["DoT_stacks+"], "desc": "Heavy attacks apply 1 stack of Soulblaze."},
    {"id": 61, "x": 450, "y": 1258, "type": "default", "region": "combat", "name": "Immolate", "tags": ["DoT_dmg+"], "desc": "Soulblaze spreads to a nearby enemy when its target dies."},
    {"id": 62, "x": 800, "y": 1258, "type": "default", "region": "support", "name": "Unspoken Rite", "tags": ["inc-n_power+"], "desc": "AoE Incantations affect an extra 3m, and Corruption-removing Incantations remove an extra 10% of a wound."},
    {"id": 63, "x": 930, "y": 1258, "type": "default", "region": "hybrid", "name": "Grim Composure", "tags": ["tough+"], "desc": "+10% Toughness Damage Reduction while above 75% Peril."},
    {"id": 64, "x": 1150, "y": 1258, "type": "default", "region": "hybrid", "name": "Measured Force", "tags": ["gain_tough"], "desc": "Freezing an enemy with Dominate restores 5% Toughness per target, up to 20%."},
    ...
    {"id": 67, "x": 285, "y": 1474, "type": "keymod", "region": "combat", "name": "Unspent Wrath", "tags": ["DoT_dmg+"], "desc": "Each Soulblaze tier grants +8% damage to burning targets."},
    {"id": 68, "x": 395, "y": 1474, "type": "keymod", "region": "combat", "name": "Cinder Hoard", "tags": ["SF_on_kill"], "desc": "Soulblaze kills generate +30% Soulfire."},
    ...
    {"id": 71, "x": 285, "y": 1690, "type": "keymod", "region": "combat", "name": "Final Pyre", "tags": ["DoT_dmg+"], "desc": "Soulblaze on Elites deals +25% damage."},
    ...
    {"id": 73, "x": 580, "y": 1474, "type": "keymod", "region": "support", "name": "Willing Burden", "tags": ["team_dmg_absorb"], "desc": "Absorb an additional 10% of allies' incoming damage."},
    {"id": 74, "x": 690, "y": 1474, "type": "keymod", "region": "support", "name": "Tempered Vessel", "tags": ["tough+"], "desc": "+20% Toughness Damage Reduction while Sanctic Bond is active."},
    ...
    {"id": 76, "x": 635, "y": 1582, "type": "keymod", "region": "support", "name": "Shared Suffering", "tags": ["team_dmg_absorb"], "desc": "Absorbed damage is split evenly across all bonded allies rather than paid by you alone."},
    ...
    {"id": 78, "x": 690, "y": 1690, "type": "keymod", "region": "support", "name": "Martyr's Ledger", "tags": ["team_dmg_absorb"], "desc": "Peril gained from Sanctic Bond is halved."},
    ...
    {"id": 81, "x": 1095, "y": 1474, "type": "keymod", "region": "hybrid", "name": "Warden's Toll", "tags": ["SF_on_CC"], "desc": "Unhallowed enemies grant +50% Soulfire on death."},
    ...
    {"id": 83, "x": 1040, "y": 1582, "type": "keymod", "region": "hybrid", "name": "Hollow Ranks", "tags": ["supress+"], "desc": "Unhallowed enemies suppress their neighbours."},
    {"id": 84, "x": 1150, "y": 1582, "type": "keymod", "region": "hybrid", "name": "Steady Hand", "tags": ["ability_CD+"], "desc": "-15% Ability cooldown while any Unhallowed enemy lives."},
